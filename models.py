...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter} and is classified as {'hazardous' if self.hazardous else 'not hazadous'}"
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"A CloseApproach on {self.time_str} by a NEO at distance of {self.distance:.2f} travelling at the speed {self.velocity:.2f}"
